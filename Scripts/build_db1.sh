...
${PYTHON_PATH} -m DataProcess.cli "${DATASET_PATH}/train" "${DATASET_PATH}/train_raw_dataset" --parallel --num-processes 32
${PYTHON_PATH} -m DataProcess.cli "${DATASET_PATH}/validation" "${DATASET_PATH}/validation_raw_dataset" --parallel --num-processes 32
${PYTHON_PATH} -m DataProcess.cli "${DATASET_PATH}/test" "${DATASET_PATH}/test_raw_dataset" --parallel --num-processes 32
