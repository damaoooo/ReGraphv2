...
DATASET_PATH="/path/to/datasets/IR/Dataset-1-all/Dataset-1"
...
${PYTHON_PATH} -m DataProcess.dataset_wash --dataset-path "${DATASET_PATH}/train_raw_dataset" --output-path "${DATASET_PATH}/train_wash_dataset" --tokenizer-path "/path/to/datasets/IR/Dataset-1-all/train_corpus_tokenizer/llvm_ir_bpe.json"
${PYTHON_PATH} -m DataProcess.dataset_wash --dataset-path "${DATASET_PATH}/validation_raw_dataset" --output-path "${DATASET_PATH}/validation_wash_dataset" --tokenizer-path "/path/to/datasets/IR/Dataset-1-all/train_corpus_tokenizer/llvm_ir_bpe.json"
${PYTHON_PATH} -m DataProcess.dataset_wash --dataset-path "${DATASET_PATH}/test_raw_dataset" --output-path "${DATASET_PATH}/test_wash_dataset" --tokenizer-path "/path/to/datasets/IR/Dataset-1-all/train_corpus_tokenizer/llvm_ir_bpe.json"
